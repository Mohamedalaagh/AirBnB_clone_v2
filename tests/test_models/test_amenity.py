class TestAmenity_instantiation(unittest.TestCase):
    ...
    def test_no_args_instantiates(self):
        """Test if Amenity instantiates with no arguments."""
    ...
    def test_two_amenities_different_created_at(self):
        """Test if two Amenity instances have different created_at times."""
        am1 = Amenity()
        sleep(0.05)
        am2 = Amenity()
    ...
    def test_two_amenities_different_updated_at(self):
        """Test if two Amenity instances have different updated_at times."""
        am1 = Amenity()
        sleep(0.05)
        am2 = Amenity()
    ...
    def test_str_representation(self):
        ...
        am = Amenity()
        am.id = "123456"
        am.created_at = am.updated_at = dat
        amstr = am.__str__()
    ...
    def test_args_unused(self):
        """Test if Amenity ignores arguments."""
        am = Amenity(None)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        am = Amenity(id="345", created_at=dat_iso, updated_at=dat_iso)
        self.assertEqual(am.id, "345")
        self.assertEqual(am.created_at, dat)
        self.assertEqual(am.updated_at, dat)

    def test_instantiation_with_None_kwargs(self):
        """Test if Amenity raises TypeError with None keyword arguments."""
