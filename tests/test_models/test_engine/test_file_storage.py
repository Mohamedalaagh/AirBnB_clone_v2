#!/usr/bin/python3
"""Defines unit tests for the FileStorage class in the file_storage module.
...
class TestFileStorageInstantiation(unittest.TestCase):
    ...
    def test_file_storage_instantiation_no_args(self):
        """Test if FileStorage instantiates with no arguments."""
        self.assertEqual(type(FileStorage()), FileStorage)

    def test_file_storage_instantiation_with_arg(self):
        """Test if FileStorage raises TypeError with arguments."""
        with self.assertRaises(TypeError):
            FileStorage(None)

    def test_file_storage_file_path_is_private_str(self):
        """Test if file_path attribute is private and of type str."""
        self.assertEqual(str, type(FileStorage._FileStorage__file_path))

    def test_file_storage_objects_is_private_dict(self):
        """Test if objects attribute is private and of type dict."""
