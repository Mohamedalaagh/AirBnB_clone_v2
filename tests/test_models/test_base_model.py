class TestBaseModel_instantiation(unittest.TestCase):
    ...
    def test_no_args_instantiates(self):
        """Test if BaseModel instantiates with no arguments."""
    ...
    def test_str_representation(self):
        ...
        bm = BaseModel()
        bm.id = "123456"
        bm.created_at = bm.updated_at = dat
        bmstr = bm.__str__()
    ...
    def test_args_unused(self):
        """Test if BaseModel ignores arguments."""
        bm = BaseModel(None)
    ...
    def test_instantiation_with_kwargs(self):
        ...
        bm = BaseModel(id="345", created_at=dat_iso, updated_at=dat_iso)
        self.assertEqual(bm.id, "345")
        self.assertEqual(bm.created_at, dat)
        self.assertEqual(bm.updated_at, dat)

    def test_instantiation_with_None_kwargs(self):
        """Test if BaseModel raises TypeError with None keyword arguments."""
